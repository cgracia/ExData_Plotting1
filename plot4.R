## This script reads the electric consumption data and plots three different 
## graphs, two of them are plot2 and plot3.
...
# Second plot
plot(subdata$Combined_Time, subdata$Voltage, type = "l", xlab = "datetime",
     ylab = "Voltage")
...
# Forth plot
plot(subdata$Combined_Time, subdata$Global_reactive_power, type = "l",
